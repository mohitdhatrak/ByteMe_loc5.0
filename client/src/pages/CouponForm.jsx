...
import { RadioGroup, Text, Button, NumberInput, Select, NumberIncrementStepper, NumberInputField, NumberInputStepper, NumberDecrementStepper, Input, Box, FormControl, VStack, FormLabel, HStack, Radio, border } from '@chakra-ui/react';

const CouponForm = () => {
    return (
        <div>
            <Box>
            <Box className='Box'w="100%" h="200px" bgGradient="radial(gray.300, black.400, white.200)">
            {/* <Box> */}
